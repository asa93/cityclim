...
export type Maintenance = Database["public"]["Tables"]["Maintenances"]["Row"] & { estimate_id: string, unit_name: string, account: string, place: string, reference: string, serial: string, checkpoints: object, checkpoints_ref: object }
